...
8. [docs/DESIGNER.md](docs/DESIGNER.md) — 학습 모델 설계
9. [docs/DATA_COLLECTION.md](docs/DATA_COLLECTION.md) — GD 레벨 크롤링과 데이터 규약
10. [docs/CODE_HYGIENE.md](docs/CODE_HYGIENE.md) — 불필요 파일/코드 정리 규칙 (janitor 에이전트)
11. [docs/DEV_SETUP.md](docs/DEV_SETUP.md) — 환경 세팅
